...
default_config = {
    ...
    'Telegram': {'enabled': '0', 'token': '', 'secretKey': 'СекретныйПароль'},
    'BlockList': {
        'blockDelivery': '0',
        'blockResponse': '0',
...
def first_setup():
    ...
    print(
        f'{Fore.CYAN}{Style.BRIGHT}Привет! {Fore.RED}(`-`)/{Style.RESET_ALL}'
    )
    ...
    print(
        f'{Fore.CYAN}{Style.BRIGHT}Запусти меня снова и напиши своему Telegram-боту (если ты его включил). '
