...
class RegularExpressions(object):
    ...
    def __new__(cls, *args, **kwargs):
        if not hasattr(cls, 'instance'):
            setattr(
                cls, 'instance', super(RegularExpressions, cls).__new__(cls)
            )
        return getattr(cls, 'instance')

    def __init__(self):
        self.ORDER_PURCHASED = re.compile(
            r'Покупатель [a-zA-Z0-9]+ оплатил заказ #[A-Z0-9]{8}\.'
        )
        """
        ...
        self.ORDER_PURCHASED2 = re.compile(
            r'[a-zA-Z0-9]+, не забудьте потом нажать кнопку '
        ...
        self.ORDER_CONFIRMED = re.compile(
            r'Покупатель [a-zA-Z0-9]+ подтвердил успешное выполнение '
        ...
        self.NEW_FEEDBACK = re.compile(
            r'Покупатель [a-zA-Z0-9]+ написал отзыв к заказу #[A-Z0-9]{8}\.'
        )
        """
        ...
        self.FEEDBACK_CHANGED = re.compile(
            r'Покупатель [a-zA-Z0-9]+ изменил отзыв к заказу #[A-Z0-9]{8}\.'
        )
        """
        ...
        self.FEEDBACK_DELETED = re.compile(
            r'Покупатель [a-zA-Z0-9]+ удалил отзыв к заказу #[A-Z0-9]{8}\.'
        )
        """
        ...
        self.NEW_FEEDBACK_ANSWER = re.compile(
            r'Продавец [a-zA-Z0-9]+ ответил на отзыв к заказу #[A-Z0-9]{8}\.'
        )
        """
        ...
        self.FEEDBACK_ANSWER_CHANGED = re.compile(
            r'Продавец [a-zA-Z0-9]+ изменил ответ на отзыв к '
            r'заказу #[A-Z0-9]{8}\.'
        )
        """
        ...
        self.FEEDBACK_ANSWER_DELETED = re.compile(
            r'Продавец [a-zA-Z0-9]+ удалил ответ на отзыв к заказу '
            r'#[A-Z0-9]{8}\.'
        )
        """
        ...
        self.ORDER_REOPENED = re.compile(
            r'Заказ #[A-Z0-9]{8} открыт повторно\.'
        )
        """
        ...
        self.REFUND = re.compile(
            r'Продавец [a-zA-Z0-9]+ вернул деньги покупателю [a-zA-Z0-9]+ '
        ...
        self.PARTIAL_REFUND = re.compile(
            r'Часть средств по заказу #[A-Z0-9]{8} возвращена покупателю\.'
        )
        """
        ...
        self.ORDER_CONFIRMED_BY_ADMIN = re.compile(
            r'Администратор [a-zA-Z0-9]+ подтвердил успешное выполнение '
            r'заказа #[A-Z0-9]{8} и отправил деньги продавцу [a-zA-Z0-9]+\.'
        )
        """
        ...
        self.FULL_ORDER_DATE = re.compile(
            r'\d{1,2} [а-я]+ \d{4}, \d{1,2}:\d{1,2}'
        )
        """
