...
print(
    f'{Fore.MAGENTA}{Style.BRIGHT}By {Fore.BLUE}{Style.BRIGHT}NightStranger, Lemarty{Style.RESET_ALL}'
)
print(
    f'{Fore.MAGENTA}{Style.BRIGHT} * GitHub: {Fore.BLUE}{Style.BRIGHT}https://github.com/NightStrang6r/FunPayVertex{Style.RESET_ALL}'
)
print(
    f'{Fore.MAGENTA}{Style.BRIGHT} * Telegram: {Fore.BLUE}{Style.BRIGHT}https://t.me/funpayplace'
)
print(
    f'{Fore.MAGENTA}{Style.BRIGHT} * Discord: {Fore.BLUE}{Style.BRIGHT}https://dsc.gg/funpay\n'
)
...
try:
    ...
    RAW_AR_CFG = cfg_loader.load_raw_auto_response_config(
    ...
    logger.error(
        'Произошла ошибка при расшифровке UTF-8. Убедитесь, что кодировка файла = UTF-8, '
